...
const SONG_SRC = '/Christina Perri - A Thousand Years.mp3';
    ...
    return (
        <div className="fixed bottom-6 right-6 z-[1000] flex flex-col items-end gap-3 pointer-events-none">
            ...
            <AnimatePresence>
                {showHint && !isPlaying && (
                    <motion.div
                        ...
                        style={{ borderColor: 'rgba(226, 133, 110, 0.3)' }}
                    >
                        <motion.span
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="pointer-events-auto relative w-14 h-14 rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(226,133,110,0.4)] border-2 border-white group"
                style={{
                ...
                {isPlaying && (
                    <>
                        <motion.div
                            ...
                            style={{ borderColor: 'rgba(226, 133, 110, 0.4)' }}
                        />
                        <motion.div
                            className="absolute inset-0 rounded-full border border-primary/40"

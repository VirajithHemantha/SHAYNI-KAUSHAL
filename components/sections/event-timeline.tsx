      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          ...
          <h2 className="font-serif text-4xl font-light tracking-[0.04em] text-[#5a1220] md:text-6xl">
            Our <span className="text-[#F8E6A6]">Journey</span>
          </h2>
        ...
        >
          ...
          <motion.div
            ...
            viewport={viewportSettings}
            className="absolute left-1/2 top-0 hidden h-full w-px -translate-x-1/2 bg-gradient-to-b from-transparent via-[#F8E6A6]/80 to-transparent md:block origin-top"
          />
              ...
              return (
                ...
                >
                  ...
                  <div className={`${isLeft ? 'md:block' : 'md:hidden'}`}>
                    <motion.div
                      whileHover={{ y: -6 }}
                      className="group relative overflow-hidden rounded-[1.8rem] border border-[#F8E6A6]/18 bg-[linear-gradient(180deg,rgba(255,250,244,0.98)_0%,rgba(245,230,200,0.94)_100%)] p-7 shadow-[0_22px_50px_rgba(30,12,16,0.16)] transition-all md:p-8"
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="mt-5 flex items-center gap-3">
                          ...
                          <span className="text-[#F8E6A6]">{event.icon}</span>
                        </div>
                      </div>
                    </motion.div>
                  </div>
                  ...
                  <div className="relative z-20 mx-auto">
                    ...
                    >
                      <motion.div
                        ...
                        className="absolute inset-0 rounded-full bg-[#F8E6A6]/20 blur-md"
                      />

                      <div className="relative flex h-16 w-16 items-center justify-center rounded-full border border-[#F8E6A6]/28 bg-[radial-gradient(circle_at_top,#fff3d0_0%,#ecd594_38%,#d0a82f_100%)] shadow-[0_10px_28px_rgba(201,162,39,0.22)]">
                  ...
                  <div className="md:hidden">
                    <motion.div
                      whileHover={{ y: -4 }}
                      className="group relative overflow-hidden rounded-[1.6rem] border border-[#F8E6A6]/18 bg-[linear-gradient(180deg,rgba(255,250,244,0.98)_0%,rgba(245,230,200,0.94)_100%)] p-6 shadow-[0_18px_40px_rgba(30,12,16,0.14)]"
                    >
                      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(201,162,39,0.12),transparent_28%)]" />
                      <div className="absolute inset-3 rounded-[1.2rem] border border-[#F8E6A6]/12" />

...
export default function CountdownSection() {
  ...
  const targetDate = useMemo(() => new Date('2026-06-29T09:05:00').getTime(), []);
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -left-[12%] top-[-8%] h-[50vw] w-[50vw] rounded-full bg-gradient-to-br from-[#731e3d]/20 to-[#91274d]/10 opacity-70 blur-[110px]"
        />
        <motion.div
          animate={{ x: [0, -45, 0], y: [0, -45, 0], scale: [1, 1.18, 1] }}
          transition={{ duration: 19, repeat: Infinity, ease: 'easeInOut', delay: 1.8 }}
          className="absolute -right-[10%] top-[32%] h-[42vw] w-[42vw] rounded-full bg-gradient-to-tl from-[#731e3d]/15 to-white opacity-60 blur-[110px]"
        />
        <motion.div
          animate={{ x: [0, 24, 0], y: [0, -35, 0] }}
          transition={{ duration: 13, repeat: Infinity, ease: 'easeInOut', delay: 0.8 }}
          className="absolute bottom-[-20%] left-[18%] h-[44vw] w-[44vw] rounded-full bg-[#731e3d]/10 opacity-45 blur-[110px]"
        />
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        >
          <motion.div
            ...
            className="mb-7 inline-flex items-center gap-2 rounded-full border border-primary/45 bg-white/70 px-5 py-2.5 shadow-[0_10px_30px_rgba(115,30,61,0.1)] backdrop-blur-md"
          >

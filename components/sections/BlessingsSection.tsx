    ...
    >
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -left-[10%] top-[20%] h-[40vw] w-[40vw] rounded-full bg-gradient-to-tr from-[#ffdce1] to-[#f0f9f0] opacity-70 blur-[100px]"
        />
        <motion.div
          animate={{ x: [0, -40, 0], y: [0, 50, 0], scale: [1, 1.1, 1] }}
          transition={{ duration: 18, repeat: Infinity, ease: 'easeInOut', delay: 2 }}
          className="absolute -right-[10%] -top-[10%] h-[50vw] w-[50vw] rounded-full bg-gradient-to-bl from-[#fdf2f4] to-[#f0f9f0] opacity-60 blur-[100px]"
        />
        <div
          className="absolute inset-0 opacity-[0.18]"
          style={{
            backgroundImage:
              'radial-gradient(circle at 10px 10px, var(--pink-dark) 1px, transparent 1px)',
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        >
          <motion.div
            ...
            className="relative mx-auto mb-8 h-32 w-32 rounded-full border-8 border-white bg-white p-[2px] shadow-[0_18px_42px_rgba(142,28,63,0.15)] md:h-44 md:w-44"
          >
            ...
            <Sparkles className="absolute -bottom-4 -left-2 h-6 w-6 animate-pulse text-secondary/60" />
          </motion.div>

          <motion.div
            whileHover={{ scale: 1.05, rotate: 2 }}
            className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/45 bg-white/70 px-5 py-2.5 shadow-[0_10px_30px_rgba(142,28,63,0.1)] backdrop-blur-md"
          >
        ...
        <div className="grid items-start gap-8 md:gap-10 lg:grid-cols-[1fr_1.2fr] lg:gap-12">
          ...
          >
            <div className="relative overflow-hidden rounded-[2.5rem] border border-primary/10 bg-white/90 p-6 shadow-[0_20px_52px_rgba(142,28,63,0.1)] backdrop-blur-xl md:p-10">
              ...
              <div className="relative z-10">
                ...
                <motion.form onSubmit={handleAddBlessing} className="space-y-6">
                  <label className="group block">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="h-14 w-full rounded-2xl border border-primary/10 bg-white/65 pl-12 pr-4 text-[#1A1A1A] placeholder-slate-400 outline-none transition-all duration-300 focus:border-primary focus:bg-white focus:shadow-[0_10px_20px_rgba(142,28,63,0.08)] group-hover:bg-white/90"
                        required
                      />
                    </div>
                  </label>
                  ...
                  <label className="group block">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full resize-none rounded-[1.5rem] border border-primary/10 bg-white/65 px-4 py-4 pl-12 text-[#1A1A1A] placeholder-slate-400 outline-none transition-all duration-300 focus:border-primary focus:bg-white focus:shadow-[0_10px_20px_rgba(142,28,63,0.08)] group-hover:bg-white/90"
                        required
                      />
                    </div>
                  </label>
                  ...
                  <motion.button
                    ...
                    className="group relative inline-flex w-full items-center justify-center gap-3 overflow-hidden rounded-full border border-primary bg-primary px-6 py-4 text-white shadow-[0_10px_20px_rgba(142,28,63,0.35)] transition-all hover:bg-primary/90 hover:shadow-[0_15px_30px_rgba(142,28,63,0.42)]"
                  >
            ...
            <AnimatePresence mode="popLayout">
              {blessings.map((blessing, index) => (
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-[2rem] border border-primary/10 bg-white/70 p-6 shadow-sm backdrop-blur-md transition-all hover:bg-white hover:shadow-[0_15px_30px_rgba(142,28,63,0.1)] md:p-8"
                >

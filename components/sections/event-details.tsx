  ...
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(180deg,#f8eddc_0%,#f4dfc2_18%,#6d1324_68%,#2c0610_100%)] px-4 py-24 md:px-6 md:py-32">
      ...
      <motion.div
        ...
        className="pointer-events-none absolute right-10 top-16 h-56 w-56 rounded-full border border-[#F8E6A6]/10"
      />
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          ...
          <h2 className="font-serif text-4xl font-light tracking-[0.04em] text-[#5a1220] md:text-6xl">
            Wedding <span className="text-[#F8E6A6]">Details</span>
          </h2>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      >
                        <div className="relative flex h-20 w-20 items-center justify-center rounded-full border border-[#F8E6A6]/25 bg-[linear-gradient(180deg,rgba(245,230,200,0.12),rgba(255,255,255,0.04))]">
        ...
        >
          <div className="relative overflow-hidden rounded-[1.75rem] border border-[#F8E6A6]/18 bg-[linear-gradient(180deg,rgba(255,250,244,0.96)_0%,rgba(245,230,200,0.92)_100%)] px-8 py-8 shadow-[0_18px_50px_rgba(104,47,18,0.08)]">
            <div className="absolute inset-3 rounded-[1.3rem] border border-[#F8E6A6]/10" />

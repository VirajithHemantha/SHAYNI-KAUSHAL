  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-0 h-[28rem] w-[28rem] -translate-x-1/2 rounded-full bg-[#F8E6A6]/12 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.25fr]">
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-[2rem] border border-[#F8E6A6]/20 bg-[linear-gradient(180deg,rgba(245,230,200,0.12)_0%,rgba(255,255,255,0.05)_100%)] p-6 shadow-[0_25px_80px_rgba(0,0,0,0.24)] backdrop-blur-md md:p-8"
          >
              ...
              <form onSubmit={handleAddBlessing} className="mt-8 space-y-4">
                ...
                <label className="block">
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full resize-none rounded-[1.4rem] border border-[#F8E6A6]/20 bg-[#fff8ec] px-4 py-3 text-sm leading-7 text-[#4a3327] outline-none transition placeholder:text-[#a08f80] focus:border-[#b89220] focus:ring-2 focus:ring-[#F8E6A6]/20"
                  />
                </label>

                <motion.button
                  type="submit"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[linear-gradient(180deg,#F8E6A6_0%,#ae8418_100%)] px-5 py-3 text-sm uppercase tracking-[0.2em] text-white shadow-[0_14px_28px_rgba(117,84,12,0.28)]"
